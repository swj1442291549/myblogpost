...
![Spectrum of the GC with candidate PNe with emission lines](./pngc1.jpg)
...
![Probability of a single detection for various α on a log scale based on Monte Carlo (MC) simulations with different cutoff magnitude.](./pngc2.jpg)
